...
-- CreateIndex
CREATE INDEX "CarImage_bikeId_idx" ON "CarImage"("bikeId");
...
-- AddForeignKey
ALTER TABLE "CarImage" ADD CONSTRAINT "CarImage_bikeId_fkey" FOREIGN KEY ("bikeId") REFERENCES "Car"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserSavedBike" ADD CONSTRAINT "UserSavedBike_bikeId_fkey" FOREIGN KEY ("bikeId") REFERENCES "Car"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TestDriveBooking" ADD CONSTRAINT "TestDriveBooking_bikeId_fkey" FOREIGN KEY ("bikeId") REFERENCES "Car"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
