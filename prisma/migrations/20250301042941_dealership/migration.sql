...
DROP COLUMN "state",
DROP COLUMN "website",
ALTER COLUMN "name" SET DEFAULT 'KMR Motors',
ALTER COLUMN "address" SET DEFAULT '69 Bike Street, Autoville, CA 69420',
ALTER COLUMN "phone" SET DEFAULT '+1 (555) 123-4567',
ALTER COLUMN "email" SET DEFAULT 'contact@kmr.com';
