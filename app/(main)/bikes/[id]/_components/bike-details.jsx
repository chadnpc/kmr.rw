    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${bike.year} ${bike.make} ${bike.model} on KMR!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {bike.images.map((image, index) => (
                ...
                >
                  <Image
                    src={image}
                    alt={`${bike.year} ${bike.make} ${bike.model} - view ${index + 1
                      }`}
                    fill
                    className="object-cover"
                  />
        ...
        <div className="w-full lg:w-5/12">
          <div className="flex items-center justify-between">
            <Badge className="mb-2">{bike.bodyType}</Badge>
          </div>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>KMR Bike Loan Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
            ...
            <div className="flex justify-between py-2 border-b">
              ...
              <span className="font-medium">{bike.bodyType}</span>
            </div>
            <div className="flex justify-between py-2 border-b">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">KMR Motors</h4>
