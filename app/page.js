import { ChevronRight, Bike, Calendar, Shield } from "lucide-react";
...
import { bodyTypes, bikeMakes, faqItems } from "@/lib/data";
  ...
  return (
    <div className="flex flex-col pt-20">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Rent your dream bike @KMR
            </h1>
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Advanced Bike Search and test drive from thousands of bikes.
            </p>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold">Browse by maker</h2>
            <Button variant="ghost" className="flex items-center" asChild>
              <Link href="/bikes">
                View All <ChevronRight className="ml-1 h-4 w-4" />
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Thousands of verified bikes from trusted dealerships and
                private sellers.
              </p>
            </div>
            <div className="text-center">
