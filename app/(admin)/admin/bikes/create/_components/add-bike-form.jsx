...
import { addCar, processCarImageWithAI } from "@/actions/bikes";
...
const bikeStatuses = ["AVAILABLE", "UNAVAILABLE", "SOLD"];
...
export const AddBikeForm = () => {
  ...
  useEffect(() => {
    if (processImageResult?.success) {
      ...
      setValue("bodyType", bikeDetails.bodyType);
      ...
      toast.success("Successfully extracted bike details", {
        description: `Detected ${bikeDetails.year} ${bikeDetails.make} ${bikeDetails.model
  ...
  const onSubmit = async (data) => {
    ...
    // Call the addBike function with our useFetch hook
    await addCarFn({
      bikeData,
                ...
                <div className="flex items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <p className="text-sm text-gray-500">
                      Featured bikes appear on the homepage
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-amber-50 p-4 rounded-md">
                  ...
                  <ul className="space-y-1 text-sm text-amber-700">
                    ...
                    <li>• Try to capture the entire bike</li>
